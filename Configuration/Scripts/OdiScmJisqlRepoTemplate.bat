...
rem
call "<OdiScmHomeDir>\Configuration\Scripts\OdiScmFork.bat" "<ScriptsRootDir>\OdiScmJisql.bat" <SECURITY_USER> <SECURITY_UNENC_PWD> <SECURITY_DRIVER> <SECURITY_URL> %1 %2 %3
