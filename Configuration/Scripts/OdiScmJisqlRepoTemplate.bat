...
rem
call "<OdiScmHomeDir>\Configuration\Scripts\OdiScmExecBat.bat" "<ScriptsRootDir>\OdiScmJisql.bat" /b <SECURITY_USER> <SECURITY_UNENC_PWD> <SECURITY_DRIVER> <SECURITY_URL> %1 %2 %3
