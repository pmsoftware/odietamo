...
powershell -file "%ODI_SCM_HOME%\Configuration\Scripts\OdiScmGenRestartSession.ps1" "%OUTFILE%"
if ERRORLEVEL 1 (
	echo %EM% executing PowerShell script ^<%ODI_SCM_HOME%\Configuration\Scripts\OdiScmGenRestartSession.ps1^>
	goto ExitFail
)
